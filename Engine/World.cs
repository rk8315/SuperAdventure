...
namespace Engine
{
    public static class World
    {
        ...
        // Static Constructor used to populate lists
        static World()
        {
            PopulateItems();
            PopulateMonsters();
        ...
        // Create game objects and add to static lists
        ...
        private static void PopulateLocations()
        {
            ...
            Vendor ralphTheRatCatcher = new Vendor("Ralph the Rat-Catcher");
            ralphTheRatCatcher.AddItemToInventory(ItemByID(ITEM_ID_PIECE_OF_FUR), 5);
            ralphTheRatCatcher.AddItemToInventory(ItemByID(ITEM_ID_RAT_TAIL), 3);

            townSquare.VendorWorkingHere = ralphTheRatCatcher;
        ...
        // Methods to call to get values from static lists 
